<template>
     ...
     <section class="about" id="about">
          <div class="content">
               ...
               <p class="guide-p">Eventyr es un servidor de supervivencia con elementos modificados en PvE & PvP. La
               ...
               <br />
               <p class="guide-p">Tanto para el PvP, como para el PvE el servidor dispone de más de 150 encantamientos
